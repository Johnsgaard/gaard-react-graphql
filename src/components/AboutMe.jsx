...
const AboutMe = () => {
    const offsetXMax = 500;
    const offsetYMax = 500;
                ...
                <div id="parallax" className="home-content text-start">
                    <div className="row mt-5 mt-sm-2 mt-md-1 mt-lg-0 mt-xl-0">
                        <div className="col-lg-5 d-flex mb-md-60 mt-5 mt-md-3 mt-sm-5">
                            <div className="mt-sm-5 mt-md-5 mt-lg-5">
                                ...
                                <div className="text-justify services-descr">
                                    <p>
                                        <span className="dropcap font-alt">H</span>ello, I'm Joshua. I am a developer &
                                        programmer living in Campbell River, British Columbia Canada. I am extremely
                                        passionate about designing and developing advanced web applications and user
                                        interfaces. I have years of experience in a diverse set of programming languages
                                        and tools, ranging from client side (HTML5, SCSS, Javascript, React, Apollo), to
                                        server side (Node, Apollo-server, GraphQL, PHP, C#, Java), to the database
                                        (MySQL, PL/SQL, PostgreSQL) and much much more. I am always looking for more
                                        challenges to help me grow as a developer.
                                    </p>
                                    <p>
                                        Aside from being a web dev, I love to spend my time camping, drawing, watching
                                        survivor, playing video games, or kickin it with the family.
                                    </p>
                                    <hr />
                                    <div>
                                        <div>
                        ...
                        <div className="split-image col-xl-6 col-lg-6 offset-lg-1 d-flex align-items-center polaroid">
                            ...
                            <img className="wow fadeScaleIn animated" src={MyImage} alt="it me" />
                        </div>
                    </div>
                </div>
            </div>
