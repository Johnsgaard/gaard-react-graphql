        ...
        <div id="home" className="appear-animate homepage">
            <div className="page bg-gray-lighter" id="top">
                <div id="sticky-wrapper" className="sticky-wrapper">
                    <nav className={`main-nav stick-fixed ${pageScrolled ? "small-height" : undefined}`}>
                    ...
                    <section className="page-section container-fluid">
                        <div className="row">
                            <div className="visibility-row">
                                <div className={`col-lg-6 col-sm-6 mb-140 mb-sm-100 mb-xs-40 wow animated fadeInLeft`}>
                                ...
                                <div className={`col-lg-6 col-sm-6 mb-140 mb-sm-100 mb-xs-40 wow animated fadeInLeft`}>
                                    <div className="post-prev-title font-alt">Scout by the ocean</div>
                                    <div className="post-prev-img">
                            ...
                            <TrackVisibility once partialVisibility>
                                {({ isVisible }) => (
                                    <div className="visibility-row">
                                        ...
                                        >
                                            <div className="post-prev-title font-alt">Kobber's 6th Birthday</div>
                                            <div className="post-prev-img">
                                ...
                                {({ isVisible }) =>
                                    console.log(isVisible) || (
                                        <div className="visibility-row">
                                            ...
                                            >
                                                <div className="post-prev-title font-alt">Scout's first halloween</div>
                                                <div className="post-prev-img">
